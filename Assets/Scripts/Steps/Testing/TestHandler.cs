...
public class TestHandler : TestManager
{
    #region Variables
    ...
    #region CollidersSet
    protected void AddOrRemoveColliderGO(bool add, GameObject go)
    {
        if (go != null)
        {
            if (add)
    ...
    protected void AddOrRemoveCollidersList(bool add, ref List<GameObject> goList)
    {
        if (add)
        {
